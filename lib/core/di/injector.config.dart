...
import 'package:chatapp/data/data_sources/local/auth_local_data_src.dart'
    as _i4;
import 'package:chatapp/data/data_sources/remote/base_service.dart' as _i6;
...
import 'package:chatapp/data/data_sources/remote/service/auth_service.dart'
    as _i7;
import 'package:chatapp/data/repositories/auth_repository_impl.dart' as _i9;
import 'package:chatapp/domain/modules/auth/auth_repository.dart' as _i8;
import 'package:chatapp/domain/modules/auth/auth_usecase.dart' as _i10;
import 'package:chatapp/presentation/app/bloc/app_bloc.dart' as _i12;
import 'package:chatapp/presentation/auth/login/bloc/login_bloc.dart' as _i11;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.singleton<_i6.BaseService>(
        _i6.BaseService(interceptor: gh<_i5.DioInterceptor>()));
    ...
    gh.factory<_i11.LoginBloc>(
        () => _i11.LoginBloc(authRepo: gh<_i8.AuthRepository>()));
