...
import 'package:chatapp/data/repositories/auth_repo_impl.dart' as _i67;
...
import 'package:chatapp/data/repositories/notification_repo_impl.dart' as _i57;
import 'package:chatapp/data/repositories/search_repo_impl.dart' as _i60;
import 'package:chatapp/data/repositories/user_repo_impl.dart' as _i63;
...
import 'package:chatapp/domain/modules/app_settings/app_settings_usecase.dart'
    as _i17;
import 'package:chatapp/domain/modules/auth/auth_repository.dart' as _i66;
import 'package:chatapp/domain/modules/auth/auth_usecase.dart' as _i68;
...
import 'package:chatapp/domain/modules/notification/notification_usecase.dart'
    as _i58;
import 'package:chatapp/domain/modules/search/search_repository.dart' as _i59;
import 'package:chatapp/domain/modules/search/search_use_case.dart' as _i61;
import 'package:chatapp/domain/modules/user/user_repository.dart' as _i62;
import 'package:chatapp/domain/modules/user/user_usecase.dart' as _i64;
import 'package:chatapp/presentation/app/app_settings_cubit/app_settings_cubit.dart'
    as _i25;
import 'package:chatapp/presentation/app/bloc/app_bloc.dart' as _i88;
...
import 'package:chatapp/presentation/notification/bloc/notification_bloc.dart'
    as _i83;
import 'package:chatapp/presentation/search/bloc/search_bloc.dart' as _i84;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.singleton<_i12.OtherLocalDataSrc>(_i12.OtherLocalDataSrc());
    ...
    gh.factory<_i32.NotificationsService>(() => _i32.NotificationsService(
          gh<_i28.BaseService>(),
          gh<_i12.OtherLocalDataSrc>(),
        ));
    gh.factory<_i33.SearchService>(
        () => _i33.SearchService(service: gh<_i28.BaseService>()));
    gh.lazySingleton<_i34.UserService>(
        () => _i34.UserService(service: gh<_i28.BaseService>()));
    gh.lazySingleton<_i35.AuthService>(() => _i35.AuthService(
          gh<_i28.BaseService>(),
          gh<_i12.OtherLocalDataSrc>(),
        ));
    ...
    gh.factory<_i39.DeviceRepository>(
        () => _i40.DeviceRepoImpl(deviceService: gh<_i29.DeviceService>()));
    ...
    gh.factory<_i56.NotificationRepository>(
        () => _i57.NotificationRepositoryImpl(
              gh<_i32.NotificationsService>(),
              gh<_i29.DeviceService>(),
            ));
    gh.factory<_i58.NotificationUseCase>(
        () => _i58.NotificationUseCaseImpl(gh<_i56.NotificationRepository>()));
    gh.factory<_i59.SearchRepository>(
        () => _i60.SearchRepositoryImpl(service: gh<_i33.SearchService>()));
    ...
    gh.singleton<_i65.AppNotificationCubit>(_i65.AppNotificationCubit(
      gh<_i44.FriendUseCase>(),
      gh<_i48.GroupUseCase>(),
    ));
    gh.factory<_i66.AuthRepository>(() => _i67.AuthRepositoryImpl(
          gh<_i3.AuthFirebase>(),
          gh<_i35.AuthService>(),
          gh<_i62.UserRepository>(),
          gh<_i4.AuthLocalDataSrc>(),
          gh<_i19.LocalDataSrc>(),
        ));
    gh.factory<_i68.AuthUseCase>(
        () => _i68.AuthUseCaeImpl(repo: gh<_i66.AuthRepository>()));
    gh.factory<_i69.ChatRoomBloc>(
        () => _i69.ChatRoomBloc(gh<_i38.ChatRoomUseCase>()));
    gh.factory<_i70.CubitSubmitNewGroupCubit>(
        () => _i70.CubitSubmitNewGroupCubit(gh<_i48.GroupUseCase>()));
    gh.factory<_i71.EditFormSubmitBloc>(
        () => _i71.EditFormSubmitBloc(userUseCase: gh<_i64.UserUseCase>()));
    gh.factory<_i72.EditGroupCubit>(
        () => _i72.EditGroupCubit(gh<_i48.GroupUseCase>()));
    gh.factory<_i73.EditProfileFormCubit>(
        () => _i73.EditProfileFormCubit(userUseCase: gh<_i64.UserUseCase>()));
    gh.factory<_i74.FindFriendBloc>(
        () => _i74.FindFriendBloc(userRepo: gh<_i62.UserRepository>()));
    gh.factory<_i75.ForgotPasswordCubit>(
        () => _i75.ForgotPasswordCubit(gh<_i68.AuthUseCase>()));
    gh.factory<_i76.FriendDetailCubit>(() => _i76.FriendDetailCubit(
          gh<_i38.ChatRoomUseCase>(),
          gh<_i64.UserUseCase>(),
        ));
    gh.factory<_i77.FriendRequestActionCubit>(() =>
        _i77.FriendRequestActionCubit(friendUseCase: gh<_i44.FriendUseCase>()));
    gh.factory<_i78.FriendsContactBloc>(() => _i78.FriendsContactBloc(
          gh<_i44.FriendUseCase>(),
          gh<_i64.UserUseCase>(),
        ));
    gh.factory<_i79.GroupDetailsBloc>(() => _i79.GroupDetailsBloc(
          gh<_i38.ChatRoomUseCase>(),
          gh<_i48.GroupUseCase>(),
        ));
    gh.factory<_i80.GroupRequestActionCubit>(
        () => _i80.GroupRequestActionCubit(groupUC: gh<_i48.GroupUseCase>()));
    gh.factory<_i81.ListMemberCubit>(
        () => _i81.ListMemberCubit(gh<_i64.UserUseCase>()));
    gh.factory<_i82.LoginCubit>(
        () => _i82.LoginCubit(authUC: gh<_i68.AuthUseCase>()));
    gh.factory<_i83.NotificationBloc>(() => _i83.NotificationBloc(
          gh<_i58.NotificationUseCase>(),
          gh<_i44.FriendUseCase>(),
          gh<_i48.GroupUseCase>(),
        ));
    gh.factory<_i84.SearchBloc>(
        () => _i84.SearchBloc(gh<_i61.SearchUseCase>()));
    gh.factory<_i85.SettingMainCubit>(() => _i85.SettingMainCubit(
          authUseCase: gh<_i68.AuthUseCase>(),
          userUseCase: gh<_i64.UserUseCase>(),
          appSettingsUseCase: gh<_i17.AppSettingsUseCase>(),
        ));
    gh.factory<_i86.SignUpCubit>(
        () => _i86.SignUpCubit(authUC: gh<_i68.AuthUseCase>()));
    gh.factory<_i87.UpdatePasswordFormDartCubit>(() =>
        _i87.UpdatePasswordFormDartCubit(authUseCase: gh<_i68.AuthUseCase>()));
    gh.lazySingleton<_i88.AppBloc>(() => _i88.AppBloc(
          gh<_i68.AuthUseCase>(),
          gh<_i64.UserUseCase>(),
        ));
    return this;
