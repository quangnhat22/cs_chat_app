...
import 'package:chatapp/data/repositories/auth_repo_impl.dart' as _i44;
import 'package:chatapp/data/repositories/friend_repo_impl.dart' as _i30;
import 'package:chatapp/data/repositories/group_repo_impl.dart' as _i34;
import 'package:chatapp/data/repositories/message_repo_impl.dart' as _i22;
import 'package:chatapp/data/repositories/user_repo_impl.dart' as _i41;
...
import 'package:chatapp/domain/modules/app_settings/app_settings_usecase.dart'
    as _i15;
import 'package:chatapp/domain/modules/auth/auth_repository.dart' as _i43;
import 'package:chatapp/domain/modules/auth/auth_usecase.dart' as _i45;
import 'package:chatapp/domain/modules/friend/friend_repository.dart' as _i29;
import 'package:chatapp/domain/modules/friend/friend_usecase.dart' as _i31;
import 'package:chatapp/domain/modules/group/group_repository.dart' as _i33;
import 'package:chatapp/domain/modules/group/group_usecase.dart' as _i35;
...
import 'package:chatapp/domain/modules/user/user_repository.dart' as _i40;
import 'package:chatapp/domain/modules/user/user_usecase.dart' as _i42;
import 'package:chatapp/presentation/app/app_settings_cubit/app_settings_cubit.dart'
    as _i27;
import 'package:chatapp/presentation/app/bloc/app_bloc.dart' as _i57;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i29.FriendRepository>(
        () => _i30.FriendRepositoryImpl(service: gh<_i19.FriendService>()));
    gh.factory<_i31.FriendUseCase>(
        () => _i31.FriendUseCaseImpl(repo: gh<_i29.FriendRepository>()));
    gh.factory<_i32.FriendsActionCubit>(
        () => _i32.FriendsActionCubit(friendUC: gh<_i31.FriendUseCase>()));
    gh.factory<_i33.GroupRepository>(() => _i34.GroupRepoImpl(
    ...
    gh.factory<_i37.ListGroupBloc>(
        () => _i37.ListGroupBloc(groupUC: gh<_i35.GroupUseCase>()));
    gh.factory<_i38.ListGroupRequestBloc>(
        () => _i38.ListGroupRequestBloc(groupUseCase: gh<_i35.GroupUseCase>()));
    gh.factory<_i39.MessageStreamCubit>(
        () => _i39.MessageStreamCubit(messageUC: gh<_i23.MessageUseCase>()));
    gh.factory<_i40.UserRepository>(() => _i41.UserRepositoryImpl(
          service: gh<_i26.UserService>(),
          local: gh<_i12.UserLocalDataSrc>(),
          storageFirebase: gh<_i7.FileStorageFirebase>(),
        ));
    gh.factory<_i42.UserUseCase>(
        () => _i42.UserUseCaseImpl(repo: gh<_i40.UserRepository>()));
    gh.factory<_i43.AuthRepository>(() => _i44.AuthRepositoryImpl(
          authFirebase: gh<_i3.AuthFirebase>(),
          authService: gh<_i28.AuthService>(),
          userRepo: gh<_i40.UserRepository>(),
          authLocalDataSrc: gh<_i4.AuthLocalDataSrc>(),
        ));
    gh.factory<_i45.AuthUseCase>(
        () => _i45.AuthUseCaeImpl(repo: gh<_i43.AuthRepository>()));
    gh.factory<_i46.ChatRoomBloc>(() => _i46.ChatRoomBloc(
          userUC: gh<_i42.UserUseCase>(),
          friendUC: gh<_i31.FriendUseCase>(),
        ));
    gh.factory<_i47.CubitSubmitNewGroupCubit>(
        () => _i47.CubitSubmitNewGroupCubit(groupUC: gh<_i35.GroupUseCase>()));
    gh.factory<_i48.EditFormSubmitBloc>(
        () => _i48.EditFormSubmitBloc(userUseCase: gh<_i42.UserUseCase>()));
    gh.factory<_i49.EditProfileFormCubit>(
        () => _i49.EditProfileFormCubit(userUseCase: gh<_i42.UserUseCase>()));
    gh.factory<_i50.FindFriendBloc>(
        () => _i50.FindFriendBloc(userRepo: gh<_i40.UserRepository>()));
    gh.factory<_i51.FriendRequestActionCubit>(() =>
        _i51.FriendRequestActionCubit(friendUseCase: gh<_i31.FriendUseCase>()));
    gh.factory<_i52.FriendsContactBloc>(() => _i52.FriendsContactBloc(
          useCase: gh<_i31.FriendUseCase>(),
          userUseCase: gh<_i42.UserUseCase>(),
        ));
    gh.factory<_i53.GroupRequestActionCubit>(
        () => _i53.GroupRequestActionCubit(groupUC: gh<_i35.GroupUseCase>()));
    gh.factory<_i54.LoginCubit>(
        () => _i54.LoginCubit(authUC: gh<_i45.AuthUseCase>()));
    gh.factory<_i55.SettingMainCubit>(() => _i55.SettingMainCubit(
          authUseCase: gh<_i45.AuthUseCase>(),
          userUseCase: gh<_i42.UserUseCase>(),
          appSettingsUseCase: gh<_i15.AppSettingsUseCase>(),
        ));
    gh.factory<_i56.SignUpCubit>(
        () => _i56.SignUpCubit(authUC: gh<_i45.AuthUseCase>()));
    gh.lazySingleton<_i57.AppBloc>(
        () => _i57.AppBloc(authUseCase: gh<_i45.AuthUseCase>()));
    return this;
  }
}
