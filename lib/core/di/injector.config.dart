...
import 'package:chatapp/data/repositories/auth_repo_impl.dart' as _i42;
...
import 'package:chatapp/data/repositories/user_repo_impl.dart' as _i39;
...
import 'package:chatapp/domain/modules/app_settings/app_settings_usecase.dart'
    as _i15;
import 'package:chatapp/domain/modules/auth/auth_repository.dart' as _i41;
import 'package:chatapp/domain/modules/auth/auth_usecase.dart' as _i43;
...
import 'package:chatapp/domain/modules/user/user_repository.dart' as _i38;
import 'package:chatapp/domain/modules/user/user_usecase.dart' as _i40;
import 'package:chatapp/presentation/app/app_settings_cubit/app_settings_cubit.dart'
    as _i26;
import 'package:chatapp/presentation/app/bloc/app_bloc.dart' as _i54;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i37.MessageStreamCubit>(
        () => _i37.MessageStreamCubit(messageUC: gh<_i22.MessageUseCase>()));
    gh.factory<_i38.UserRepository>(() => _i39.UserRepositoryImpl(
          service: gh<_i25.UserService>(),
          local: gh<_i12.UserLocalDataSrc>(),
          storageFirebase: gh<_i7.FileStorageFirebase>(),
        ));
    gh.factory<_i40.UserUseCase>(
        () => _i40.UserUseCaseImpl(repo: gh<_i38.UserRepository>()));
    gh.factory<_i41.AuthRepository>(() => _i42.AuthRepositoryImpl(
          authFirebase: gh<_i3.AuthFirebase>(),
          authService: gh<_i27.AuthService>(),
          userRepo: gh<_i38.UserRepository>(),
          authLocalDataSrc: gh<_i4.AuthLocalDataSrc>(),
        ));
    gh.factory<_i43.AuthUseCase>(
        () => _i43.AuthUseCaeImpl(repo: gh<_i41.AuthRepository>()));
    gh.factory<_i44.ChatRoomBloc>(() => _i44.ChatRoomBloc(
          userUC: gh<_i40.UserUseCase>(),
          friendUC: gh<_i30.FriendUseCase>(),
        ));
    gh.factory<_i45.CubitSubmitNewGroupCubit>(
        () => _i45.CubitSubmitNewGroupCubit(groupUC: gh<_i34.GroupUseCase>()));
    gh.factory<_i46.EditFormSubmitBloc>(
        () => _i46.EditFormSubmitBloc(userUseCase: gh<_i40.UserUseCase>()));
    gh.factory<_i47.EditProfileFormCubit>(
        () => _i47.EditProfileFormCubit(userUseCase: gh<_i40.UserUseCase>()));
    gh.factory<_i48.FindFriendBloc>(
        () => _i48.FindFriendBloc(userRepo: gh<_i38.UserRepository>()));
    gh.factory<_i49.FriendRequestActionCubit>(() =>
        _i49.FriendRequestActionCubit(friendUseCase: gh<_i30.FriendUseCase>()));
    gh.factory<_i50.FriendsContactBloc>(() => _i50.FriendsContactBloc(
          useCase: gh<_i30.FriendUseCase>(),
          userUseCase: gh<_i40.UserUseCase>(),
        ));
    gh.factory<_i51.LoginCubit>(
        () => _i51.LoginCubit(authUC: gh<_i43.AuthUseCase>()));
    gh.factory<_i52.SettingMainCubit>(() => _i52.SettingMainCubit(
          authUseCase: gh<_i43.AuthUseCase>(),
          userUseCase: gh<_i40.UserUseCase>(),
          appSettingsUseCase: gh<_i15.AppSettingsUseCase>(),
        ));
    gh.factory<_i53.SignUpCubit>(
        () => _i53.SignUpCubit(authUC: gh<_i43.AuthUseCase>()));
    gh.lazySingleton<_i54.AppBloc>(
        () => _i54.AppBloc(authUseCase: gh<_i43.AuthUseCase>()));
    return this;
  }
}
