...
import 'package:chatapp/data/repositories/message_repo_impl.dart' as _i11;
...
import 'package:chatapp/domain/modules/message/message_repository.dart' as _i10;
import 'package:chatapp/domain/modules/message/message_usecase.dart' as _i12;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i10.MessageRepository>(() =>
        _i11.MessageRepositoryImpl(chatWebSocket: gh<_i5.ChatWebSocket>()));
    gh.factory<_i12.MessageUseCase>(
        () => _i12.MessageUseCaseImpl(repo: gh<_i10.MessageRepository>()));
    ...
    gh.singleton<_i18.BaseService>(
        _i18.BaseService(interceptor: gh<_i6.DioInterceptor>()));
    gh.factory<_i19.FriendService>(
        () => _i19.FriendService(service: gh<_i18.BaseService>()));
    gh.factory<_i20.MessageStreamCubit>(
        () => _i20.MessageStreamCubit(messageUC: gh<_i12.MessageUseCase>()));
    gh.factory<_i21.SettingLanguageCubit>(() =>
        _i21.SettingLanguageCubit(usecase: gh<_i17.AppSettingsUseCase>()));
    gh.factory<_i22.SettingThemeCubit>(
        () => _i22.SettingThemeCubit(usecase: gh<_i17.AppSettingsUseCase>()));
    gh.lazySingleton<_i23.UserService>(
        () => _i23.UserService(service: gh<_i18.BaseService>()));
    gh.factory<_i24.AppSettingsCubit>(
        () => _i24.AppSettingsCubit(useCase: gh<_i17.AppSettingsUseCase>()));
    gh.lazySingleton<_i25.AuthService>(
        () => _i25.AuthService(service: gh<_i18.BaseService>()));
    gh.factory<_i26.FriendRepository>(
        () => _i27.FriendRepositoryImpl(service: gh<_i19.FriendService>()));
    ...
    gh.factory<_i41.FriendRequestActionCubit>(() =>
        _i41.FriendRequestActionCubit(friendUseCase: gh<_i28.FriendUseCase>()));
