...
import 'package:chatapp/data/repositories/auth_repo_impl.dart' as _i41;
...
import 'package:chatapp/data/repositories/user_repo_impl.dart' as _i38;
...
import 'package:chatapp/domain/modules/app_settings/app_settings_usecase.dart'
    as _i15;
import 'package:chatapp/domain/modules/auth/auth_repository.dart' as _i40;
import 'package:chatapp/domain/modules/auth/auth_usecase.dart' as _i42;
...
import 'package:chatapp/domain/modules/user/user_repository.dart' as _i37;
import 'package:chatapp/domain/modules/user/user_usecase.dart' as _i39;
import 'package:chatapp/presentation/app/app_settings_cubit/app_settings_cubit.dart'
    as _i26;
import 'package:chatapp/presentation/app/bloc/app_bloc.dart' as _i53;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i36.MessageStreamCubit>(
        () => _i36.MessageStreamCubit(messageUC: gh<_i22.MessageUseCase>()));
    ...
    gh.factory<_i43.ChatRoomBloc>(() => _i43.ChatRoomBloc(
          userUC: gh<_i39.UserUseCase>(),
          friendUC: gh<_i30.FriendUseCase>(),
        ));
    gh.factory<_i44.CubitSubmitNewGroupCubit>(
        () => _i44.CubitSubmitNewGroupCubit(groupUC: gh<_i34.GroupUseCase>()));
    gh.factory<_i45.EditFormSubmitBloc>(
        () => _i45.EditFormSubmitBloc(userUseCase: gh<_i39.UserUseCase>()));
    gh.factory<_i46.EditProfileFormCubit>(
        () => _i46.EditProfileFormCubit(userUseCase: gh<_i39.UserUseCase>()));
    gh.factory<_i47.FindFriendBloc>(
        () => _i47.FindFriendBloc(userRepo: gh<_i37.UserRepository>()));
    gh.factory<_i48.FriendRequestActionCubit>(() =>
        _i48.FriendRequestActionCubit(friendUseCase: gh<_i30.FriendUseCase>()));
    gh.factory<_i49.FriendsContactBloc>(() => _i49.FriendsContactBloc(
          useCase: gh<_i30.FriendUseCase>(),
          userUseCase: gh<_i39.UserUseCase>(),
        ));
    gh.factory<_i50.LoginCubit>(
        () => _i50.LoginCubit(authUC: gh<_i42.AuthUseCase>()));
    gh.factory<_i51.SettingMainCubit>(() => _i51.SettingMainCubit(
          authUseCase: gh<_i42.AuthUseCase>(),
          userUseCase: gh<_i39.UserUseCase>(),
          appSettingsUseCase: gh<_i15.AppSettingsUseCase>(),
        ));
    gh.factory<_i52.SignUpCubit>(
        () => _i52.SignUpCubit(authUC: gh<_i42.AuthUseCase>()));
    gh.lazySingleton<_i53.AppBloc>(
        () => _i53.AppBloc(authUseCase: gh<_i42.AuthUseCase>()));
    return this;
  }
}
