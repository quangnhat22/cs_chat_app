...
import 'package:chatapp/data/repositories/auth_repo_impl.dart' as _i38;
...
import 'package:chatapp/data/repositories/user_repo_impl.dart' as _i35;
...
import 'package:chatapp/domain/modules/app_settings/app_settings_usecase.dart'
    as _i15;
import 'package:chatapp/domain/modules/auth/auth_repository.dart' as _i37;
import 'package:chatapp/domain/modules/auth/auth_usecase.dart' as _i39;
...
import 'package:chatapp/domain/modules/user/user_repository.dart' as _i34;
import 'package:chatapp/domain/modules/user/user_usecase.dart' as _i36;
import 'package:chatapp/presentation/app/app_settings_cubit/app_settings_cubit.dart'
    as _i26;
import 'package:chatapp/presentation/app/bloc/app_bloc.dart' as _i49;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i32.ListFriendRequestBloc>(() =>
        _i32.ListFriendRequestBloc(friendUseCase: gh<_i30.FriendUseCase>()));
    gh.factory<_i33.MessageStreamCubit>(
        () => _i33.MessageStreamCubit(messageUC: gh<_i22.MessageUseCase>()));
    gh.factory<_i34.UserRepository>(() => _i35.UserRepositoryImpl(
          service: gh<_i25.UserService>(),
          local: gh<_i12.UserLocalDataSrc>(),
          storageFirebase: gh<_i7.FileStorageFirebase>(),
        ));
    gh.factory<_i36.UserUseCase>(
        () => _i36.UserUseCaseImpl(repo: gh<_i34.UserRepository>()));
    gh.factory<_i37.AuthRepository>(() => _i38.AuthRepositoryImpl(
          authFirebase: gh<_i3.AuthFirebase>(),
          authService: gh<_i27.AuthService>(),
          userRepo: gh<_i34.UserRepository>(),
          authLocalDataSrc: gh<_i4.AuthLocalDataSrc>(),
        ));
    gh.factory<_i39.AuthUseCase>(
        () => _i39.AuthUseCaeImpl(repo: gh<_i37.AuthRepository>()));
    gh.factory<_i40.ChatRoomBloc>(() => _i40.ChatRoomBloc(
          userUC: gh<_i36.UserUseCase>(),
          friendUC: gh<_i30.FriendUseCase>(),
        ));
    gh.factory<_i41.EditFormSubmitBloc>(
        () => _i41.EditFormSubmitBloc(userUseCase: gh<_i36.UserUseCase>()));
    gh.factory<_i42.EditProfileFormCubit>(
        () => _i42.EditProfileFormCubit(userUseCase: gh<_i36.UserUseCase>()));
    gh.factory<_i43.FindFriendBloc>(
        () => _i43.FindFriendBloc(userRepo: gh<_i34.UserRepository>()));
    ...
    gh.factory<_i45.FriendsContactBloc>(() => _i45.FriendsContactBloc(
          ...
          userUseCase: gh<_i36.UserUseCase>(),
        ));
    gh.factory<_i46.LoginCubit>(
        () => _i46.LoginCubit(authUC: gh<_i39.AuthUseCase>()));
    gh.factory<_i47.SettingMainCubit>(() => _i47.SettingMainCubit(
          authUseCase: gh<_i39.AuthUseCase>(),
          userUseCase: gh<_i36.UserUseCase>(),
          appSettingsUseCase: gh<_i15.AppSettingsUseCase>(),
        ));
    gh.factory<_i48.SignUpCubit>(
        () => _i48.SignUpCubit(authUC: gh<_i39.AuthUseCase>()));
    gh.lazySingleton<_i49.AppBloc>(
        () => _i49.AppBloc(authUseCase: gh<_i39.AuthUseCase>()));
    return this;
  }
}
